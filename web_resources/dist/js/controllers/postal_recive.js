...
{ 
    ...
    var po_charges=$('#po_charges').val();
   
    if(inwardno==""||inwarddate==""||name==""||place==""||address==""||no_ref==""||date_ref==""||subject==""||remark==""||po_charges=="") 
    {
      // alert("requird");
        swal({
        title:"",
    ...
    // 	if(userId>0)
      ...
      // });
    	...
    	{a=true;
    		//alert('insert');
    		$.ajax({
        url:base_path+"Postalrecive/insertPostalrecive",
        type: "POST",
        data: $('#Form').serialize(),
         beforeSend: function(){
               $('#btn_save').prop('disabled', true);
